...
declare global {
  interface Array<T> {
    allCheck(first: any, arg: any): void

    chunk(first: any, arg: any): void

    copy(first: any, arg: any): void

    count(first: any, arg: any): void

    countAdv(first: any, arg: any): void

    countBy(first: any, arg: any): void

    equals(first: any, arg: any): void

    except(first: any, arg: any): void

    findMaxMin(first: any, arg: any): void

    fisherYates(first: any, arg: any): void

    flatten(first: any, arg: any): void

    groupBy(first: any, arg: any): void

    indexOfAll(first: any, arg: any): void

    intersect(first: any, arg: any): void

    max(first: any, arg: any): void

    mean(first: any, arg: any): void

    median(first: any, arg: any): void

    min(first: any, arg: any): void

    mode(first: any, arg: any): void

    orderBy(first: any, arg: any): void

    pick(first: any, arg: any): void

    remove(first: any, arg: any): void

    shuffle(first: any, arg: any): void

    subset(first: any, arg: any): void

    sum(first: any, arg: any): void

    union(first: any, arg: any): void

    unique(first: any, arg: any): void
  }
  interface String {
    ac(first: any, arg: any): void

    camelize(first: any, arg: any): void

    dc(first: any, arg: any): void

    deCamelize(first: any, arg: any): void

    ec(first: any, arg: any): void

    esHtml(first: any, arg: any): void

    fillStr(first: any, arg: any): void

    format(first: any, arg: any): void

    len(first: any, arg: any): void

    reHtml(first: any, arg: any): void

    render(first: any, arg: any): void

    replaceAll(first: any, arg: any): void

    tc(first: any, arg: any): void

    times(first: any, arg: any): void

    toDate(first: any, arg: any): void

    toHtml(first: any, arg: any): void

    toInt(first: any, arg: any): void

    toLow(first: any, arg: any): void

    toMoney(first: any, arg: any): void

    toUp(first: any, arg: any): void

    upperFirst(first: any, arg: any): void
  }
  interface Date {
    date2Str(first: any, arg: any): void

    date8(first: any, arg: any): void

    dateAdd(first: any, arg: any): void

    format(first: any, arg: any): void

    getWeek(first: any, arg: any): void

    isLeap(first: any, arg: any): void

    offset(first: any, arg: any): void
  }
  interface Number {
    fillStr(first: any, arg: any): void

    isPrime(first: any, arg: any): void

    prettyBytes(first: any, arg: any): void

    round(first: any, arg: any): void
  }
}
