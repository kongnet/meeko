...
describe('Math扩展函数的单元测试', () => {
  ...
  */
  ...
  it(`polyFitting ${rst4.f}`, () =>
    assertLog(JSON.stringify(rst4), `{"r":0.013006877594921203,"f":"y=7.8503*x^6+-0.6815*x^5+-11.8914*x^4+3.5150*x^3+6.1567*x^2+-1.9026*x-0.4031 R^2=0.0130"}`)
  )
})
